...
name = Label(root, text='Translator', fg="#fff", bd=0, bg="#03152D")
...
trans_button = Button(button_frame, text="Translate", font=("Arial", 10, 'bold'), bg='#303030', fg="#fff", command=translate)
